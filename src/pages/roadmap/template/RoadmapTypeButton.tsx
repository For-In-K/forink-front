...
const RoadmapTypeButton = ({
  ...
  return (
    <button
      ...
      className={`flex h-42 w-2xl flex-col items-start gap-1 rounded-3xl px-10 py-6 text-white shadow-md transition-all duration-300 hover:scale-105 hover:text-white ${
